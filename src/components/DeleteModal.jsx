...
const DeleteModal = ({id}) => {
    ...
    return (
        <>
        {isOpen && <div className="overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                <div className="flex items-center justify-center p-4 w-full max-w-md max-h-full">
                    <div className="relative bg-gray-300 border border-gray-300 rounded-xl shadow-sm p-4 md:p-6">
